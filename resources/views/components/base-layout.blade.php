...
@php
    $isBoxed = layoutConfig('collapsible-menu')['boxed'];
    $isAltMenu = layoutConfig('collapsible-menu')['alt-menu'];
@endphp
<!DOCTYPE html>
...
<head>
    ...
    @if (!Request::routeIs('404') &&
        ...
        @vite(['resources/scss/light/plugins/perfect-scrollbar/perfect-scrollbar.scss', 'resources/scss/layouts/collapsible-menu/light/structure.scss', 'resources/scss/layouts/collapsible-menu/dark/structure.scss'])
