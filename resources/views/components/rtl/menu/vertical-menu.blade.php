        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu {{ Request::is('*/app/ecommerce/*') ? 'active' : '' }}">
                <a href="#ecommerce" data-bs-toggle="collapse"
                    aria-expanded="{{ Request::is('*/app/ecommerce/*') ? 'true' : 'false' }}"
            ...
            <li class="menu {{ Request::is('*/app/blog/*') ? 'active' : '' }}">
                ...
                <ul class="collapse submenu list-unstyled {{ Request::is('*/app/blog*') ? 'show' : '' }}"
            ...
            <li class="menu {{ Request::is('*/component/*') ? 'active' : '' }}">
                <a href="#components" data-bs-toggle="collapse"
                    aria-expanded="{{ Request::is('*/component/*') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <ul class="collapse submenu list-unstyled {{ Request::is('*/component/*') ? 'show' : '' }}"
                    id="components" data-bs-parent="#accordionExample">
            ...
            <li class="menu {{ Request::is('*/element/*') ? 'active' : '' }}">
                <a href="#elements" data-bs-toggle="collapse"
                    aria-expanded="{{ Request::is('*/element/*') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <ul class="collapse submenu list-unstyled {{ Request::is('*/element/*') ? 'show' : '' }}"
                    id="elements" data-bs-parent="#accordionExample">
            ...
            <li class="menu {{ Request::is('*/layout/*') ? 'active' : '' }}">
                <a href="#layouts" data-bs-toggle="collapse"
                    aria-expanded="{{ Request::is('*/layout/*') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <ul class="collapse submenu list-unstyled {{ Request::is('*/layout/*') ? 'show' : '' }}"
            ...
            <li class="menu {{ Request::is('*/datatables/*') ? 'active' : '' }}">
                <a href="#datatables" data-bs-toggle="collapse"
                    aria-expanded="{{ Request::is('*/datatables/*') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <ul class="collapse submenu list-unstyled {{ Request::is('*/datatables/*') ? 'show' : '' }}"
                    id="datatables" data-bs-parent="#accordionExample">
            ...
            <li class="menu {{ Request::is('*/form/*') ? 'active' : '' }}">
                <a href="#forms" data-bs-toggle="collapse"
                    aria-expanded="{{ Request::is('*/form/*') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <ul class="collapse submenu list-unstyled {{ Request::is('*/form/*') ? 'show' : '' }}"
                    id="forms" data-bs-parent="#accordionExample">
                    <li class="{{ Request::routeIs('basic') ? 'active' : '' }}">
            ...
            <li class="menu {{ Request::is('*/user/*') ? 'active' : '' }}">
                ...
                <ul class="collapse submenu list-unstyled {{ Request::is('*/user/*') ? 'show' : '' }}"
            ...
            <li class="menu {{ Request::is('*/page/*') ? 'active' : '' }}">
                <a href="#pages" data-bs-toggle="collapse"
                    aria-expanded="{{ Request::is('*/page/*') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <li class="menu">
                <a target="_blank" href="https://designreset.com/cork/documentation/laravel/index.html"
            ...
            <li class="menu">
                <a target="_blank" href="https://designreset.com/cork/documentation/laravel/changelog.html"
                    aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
