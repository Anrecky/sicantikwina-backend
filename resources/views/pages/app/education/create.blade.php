<x-base-layout :scrollspy="false">
    ...
    <x-slot:pageTitle>
        ...
        <x-slot:headerFiles>
            ...
            <!-- /BREADCRUMB -->
            <form id="createForm" action="{{ route('education.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="widget-content widget-content-area blog-create-section">
                            <div class="row mb-4">
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="post-title"
                                        placeholder="Judul Edukasi" name="title">
                                    @if ($errors->get('title'))
                            ...
                            <div class="row mb-4">
                                <div class="col-sm-12">
                                    ...
                                    <textarea name="content" class="d-none" id="post-content"></textarea>
                            ...
                            <div class="row">
                                <div class="col-xxl-12 mb-4">
                                    <div class="switch form-switch-custom switch-inline form-switch-primary">
                                        ...
                                        <input name="is_publish" value="0" class="switch-input" type="checkbox"
                                            role="switch" id="showPublicly">
                                ...
                                <div class="col-xxl-12 col-sm-4 col-12 mx-auto">
                                    <button type="submit" class="btn btn-success w-100">Tambahkan Edukasi</button>
                                </div>
            ...
            <x-slot:footerFiles>
                ...
                @vite(['resources/assets/js/apps/education-create.js'])
