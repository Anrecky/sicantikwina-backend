    ...
    <x-slot:pageTitle>
        ...
        <x-slot:headerFiles>
            ...
            <div class="row mb-4 layout-spacing layout-top-spacing">
                ...
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="widget-content widget-content-area blog-create-section">
                        <form method="POST" action="{{ route('complaint.update', $complaint) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="px-4">
                                <div class="row mb-4">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $complaint->whistleblower_name }}" name="wb_name"
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-check form-check-primary form-check-inline">
                                            <input class="form-check-input" value="0" id="wbRadioDOB"
                                                type="radio" @if (!$complaint->whistleblower_is_year) checked @endif
                                                name="wb_is_year">
                                        ...
                                        <div class="form-check form-check-primary form-check-inline">
                                            <input class="form-check-input"
                                                @if ($complaint->whistleblower_is_year) checked @endif id="wbRadioYear"
                                                value="1" type="radio" name="wb_is_year">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="wbDOB" value="{{ $complaint->whistleblower_dob }}"
                                                class="form-control flatpickr flatpickr-input @if ($complaint->whistleblower_is_year) d-none @endif"
                                                type="text" name="wb_dob" placeholder="Pilih Tanggal Lahir..."
                                                aria-label="kalender" aria-describedby="basic-addon1">

                                            <input type="text" value="{{ $complaint->whistleblower_year }}"
                                                class="form-control @if (!$complaint->whistleblower_is_year) d-none @endif "
                                                id="wbYear" name="wb_year" placeholder="Tahun Lahir Pelapor">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-check form-check-primary form-check-inline">
                                            <input class="form-check-input" type="radio" name="wb_gender"
                                                ...
                                                @if ($complaint->whistleblower_gender == 'female') checked @else checked @endif>
                                        ...
                                        <div class="form-check form-check-primary form-check-inline">
                                            <input class="form-check-input" type="radio" value="male"
                                                ...
                                                @if ($complaint->whistleblower_gender == 'male') checked @endif>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-12">
                                        <label>Alamat</label>
                                        <input type="text" class="form-control"
                                            value="{{ $complaint->whistleblower_address }}" name="wb_address"
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $complaint->whistleblower_phone }}" name="wb_phone"
                                            placeholder="No. Telepon Pelapor">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $complaint->relationship }}" name="relationship"
                                            placeholder="Contoh: Kakak Kandung Pengantin Pria">
                            ...
                            <div class="px-4">
                                <div class="row mb-4">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="bride_name"
                                            placeholder="Nama Pengantin Perempuan"
                                            value="{{ $complaint->bride_name }}">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-check form-check-primary form-check-inline">
                                            <input class="form-check-input" value="0" id="brideRadioDOB"
                                                type="radio" @if (!$complaint->bride_is_year) checked @endif
                                                name="bride_is_year">
                                        ...
                                        <div class="form-check form-check-primary form-check-inline">
                                            <input class="form-check-input"
                                                @if ($complaint->bride_is_year) checked @endif id="brideRadioYear"
                                                value="1" type="radio" name="bride_is_year">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="brideDOB" value="{{ $complaint->bride_dob }}"
                                                class="form-control flatpickr flatpickr-input @if ($complaint->bride_is_year) d-none @endif"
                                                type="text" name="bride_dob" placeholder="Pilih Tanggal Lahir..."
                                                aria-label="kalender" aria-describedby="basic-addon1">
                                            <input type="text"
                                                class="form-control @if (!$complaint->bride_is_year) d-none @endif"
                                                id="brideYear" name="bride_year" placeholder="Tahun Lahir Pelapor">
                                            ...
                                            @endif
                                            @if ($errors->get('bride_year'))
                                                <ul class='text-sm text-danger my-2'>
                                                    @foreach ((array) $errors->get('bride_year') as $message)
                                                        <li>{{ _($message) }}</li>
                                                    @endforeach
                                                </ul>
                                            @endif
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-12">
                                        <label>Alamat</label>
                                        <input type="text" class="form-control"
                                            value="{{ $complaint->bride_address }}" name="bride_address"
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-12">
                                        <label>No. Telepon</label>
                                        <input type="text" class="form-control"
                                            value="{{ $complaint->bride_phone }}" name="bride_phone"
                            ...
                            <div class="px-4">
                                <div class="row mb-4">
                                    <div class="col-sm-12">
                                        <label>Nama</label>
                                        <input type="text" class="form-control"
                                            value="{{ $complaint->groom_name }}" name="groom_name"
                                            placeholder="Nama Pengantin Laki - Laki">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-check form-check-primary form-check-inline">
                                            <input class="form-check-input" value="0" id="groomRadioDOB"
                                                type="radio" @if (!$complaint->groom_is_year) checked @endif
                                                name="groom_is_year">
                                        ...
                                        <div class="form-check form-check-primary form-check-inline">
                                            <input class="form-check-input"
                                                @if ($complaint->groom_is_year) checked @endif id="groomRadioYear"
                                                value="1" type="radio" name="groom_is_year">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="groomDOB" value="{{ $complaint->groom_dob }}"
                                                class="form-control flatpickr flatpickr-input @if ($complaint->groom_is_year) d-none @endif"
                                                type="text" name="groom_dob" placeholder="Pilih Tanggal Lahir..."
                                                aria-label="kalender" aria-describedby="basic-addon1">
                                            <input type="text"
                                                class="form-control @if (!$complaint->groom_is_year) d-none @endif"
                                                id="groomYear" name="groom_year" placeholder="Tahun Lahir Pelapor">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-12">
                                        <label>Alamat</label>
                                        <input type="text" class="form-control"
                                            value="{{ $complaint->groom_address }}" name="groom_address"
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-12">
                                        <label>No. Telepon</label>
                                        <input type="text" class="form-control"
                                            value="{{ $complaint->groom_phone }}" name="groom_phone"
                            ...
                            <div class="row mb-4">
                                <div class="col-sm-12">
                                    ...
                                    <textarea class="form-control" name="chronology" rows="4">{{ $complaint->chronology }}</textarea>
                            ...
                            <div class="row mb-4">
                                <div class="col-sm-12">
                                    <button type="submit" class="btn btn-warning btn-lg mb-2 me-4">Edit
                                        Pengaduan</button>
                                </div>
                            </div>
                        </form>
            ...
            <x-slot:footerFiles>
                ...
                @vite(['resources/assets/js/apps/complaint-edit.js'])
